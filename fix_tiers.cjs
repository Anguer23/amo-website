...
// Fix minimum height of description
content = content.replace(
  ...
  'p className="text-white/40 font-light text-sm leading-relaxed mb-6 group-hover:text-white/60 transition-colors duration-500 min-h-[120px]">{tier.description}</p>'
);
